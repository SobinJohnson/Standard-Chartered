...
const ChatBox = () => {
  ...
  const questions = [
    ...
    { type: "text", text: "What is your Aadhaar number?" },
  ...
  return (
    <div className="h-full rounded-2xl w-[420px] overflow-hidden border-4 ml-40 bg-gray-100 flex flex-col justify-end">
